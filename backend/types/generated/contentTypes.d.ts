...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    philosophy: Schema.Attribute.Component<'shared.value', true>;
    publishedAt: Schema.Attribute.DateTime;
    story_image: Schema.Attribute.Media<'images'>;
    story_text_1: Schema.Attribute.RichText;
    story_text_2: Schema.Attribute.RichText;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    show_contact_button: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    site_logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
